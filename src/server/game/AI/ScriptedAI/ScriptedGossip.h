...
enum eTradeskill
{
    ...
    TRADESKILL_COMMON                   = 16,
    TRADESKILL_DWARVISH                 = 17,
    TRADESKILL_GNOMISH                  = 18,
    TRADESKILL_DARNASSIAN               = 19,
    TRADESKILL_DRAENEI                  = 20,
    TRADESKILL_ORCISH                   = 21,
    TRADESKILL_TROLL                    = 22,
    TRADESKILL_TAUREHE                  = 23,
    TRADESKILL_GUTTERSPEAK              = 24,
    TRADESKILL_THALASSIAN               = 25,
    TRADESKILL_DEMONIC                  = 26,
