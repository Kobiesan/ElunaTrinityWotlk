...
void WorldSession::SendNotInArenaTeamPacket(uint8 type)
{
    ...
    if (!error)
        data << uint8(type);                                // team type (1=1v1, 2=2v2, 3=3v3), can be used for custom types...
    SendPacket(&data);
}
...
+ERR_ARENA_TEAM_CREATE_S "%s created.  To disband, use /teamdisband [1v1, 2v2, 3v3]."
+ERR_ARENA_TEAM_INVITE_SS "You have invited %s to join %s"
+ERR_ARENA_TEAM_QUIT_S "You are no longer a member of %s"
ERR_ARENA_TEAM_FOUNDER_S "Congratulations, you are a founding member of %s!  To leave, use /teamquit [1v1, 2v2, 3v3]."
...
+ERR_ARENA_TEAM_YOU_JOIN_S "You have joined %s.  To leave, use /teamquit [1v1, 2v2, 3v3]."
