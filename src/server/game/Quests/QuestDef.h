...
enum QuestTradeSkill
{
    ...
    QUEST_TRSKILL_COMMON         = 15,
    QUEST_TRSKILL_DWARVISH       = 16,
    QUEST_TRSKILL_GNOMISH        = 18,
    QUEST_TRSKILL_DARNASSIAN     = 19,
    QUEST_TRSKILL_DRAENEI        = 20,
    QUEST_TRSKILL_ORCISH         = 21,
    QUEST_TRSKILL_TROLL          = 22,
    QUEST_TRSKILL_TAUREHE        = 23,
    QUEST_TRSKILL_GUTTERSPEAK    = 24,
    QUEST_TRSKILL_THALASSIAN     = 25,
    QUEST_TRSKILL_DEMONIC        = 26,
    QUEST_TRSKILL_DRACONIC       = 27,
    QUEST_TRSKILL_TITAN          = 28,
    QUEST_TRSKILL_KALIMAG        = 29
};
